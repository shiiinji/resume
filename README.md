...
- 使用技術
  ...
  - フロントエンド: React, React-Router → Next.js, Redux (Redux-Thunk)、Material-UI
...
自社で初iOSアプリとしてアイドルアプリをリリースすることに成功しました。ゲームパートのドット絵のデザインを除いて、アプリ開発、リリース作業等のすべてのプロジェクトを担当しました。
