...
TypeScript／JavaScript を中心に フロントエンド・バックエンド・インフラを横断して開発するフルスタックエンジニアです。現在はハピログ株式会社で保守運用を担いながら、プラスチック成形材料データベース 「PlaBase」 の日本／米国向け展開を主導。副業では polyfit でテックリードとして教育委員会向け SaaS・PTA 集金機能をリリースしました。長期保守を見据えたアーキテクチャ設計・CI/CD、およびフルスタックでの開発が得意分野です。
...
| 期間             | 会社・雇用形態                       | ポジション・役割                                                                                                                                                         |
|----------------| ----------------------------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **2013/01〜現在** | ハピログ株式会社 ／ 正社員                | フルスタックエンジニア (保守運用・新規開発／日本人唯一の正社員エンジニアとしてインド・オフショア4名をマネジメント)。ピアズ・マネジメント株式会社: 2013年1月～2018年6月 (2012年8月よりインターン)。事業の主体を事業会社に移行したことに伴う転籍であるため、仕事内容や開発体制等の実体に変更はありません。 |
| **2024/04〜2025/05** | polyfit株式会社 ／ 業務委託            | テックリード (教育委員会向け SaaS・PTA 集金 Stripe Connect)                                                                                                                      |
| 2021/09〜2021/11     | メダップ株式会社 ／ 業務委託               | React フロント機能実装・テスト環境整備                                                                                                                                           |
| 2021/11〜2022/09     | Ubie株式会社 ／ 業務委託               | 新規 SaaS 基盤開発 (React／Kotlin)                                                                                                                                      |
| 2022/12〜2024/03     | justInCaseTechnologies ／ 業務委託 | ノーコードフォーム SaaS 開発                                                                                                                                                |
| 2013/01〜2018/06     | ピアズ・マネジメント株式会社 ／ 正社員          | PM → フルスタックエンジニア (フォトブックサービス等)                                                                                                                                   |
